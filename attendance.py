...
class Attendance:
	...
	def __init__(self,root):
        ...
        #title section
		title_lb1 = Label(bg_img,text="Attendance",font=("verdana",30,"bold"),bg="white",fg="navyblue")
		...
		#create table 
		self.attendanceReport_left = ttk.Treeview(table_frame,column=("ID","Name","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
		...
		#create table 
		self.attendanceReport = ttk.Treeview(table_frame,column=("ID","Name","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
