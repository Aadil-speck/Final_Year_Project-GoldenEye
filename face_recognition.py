...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        # first header image  
        img=Image.open(r"/home/pi/Desktop/Golden Eye/Pics_GUI/Main/banner1.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Golden Eye",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1366,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"/home/pi/Desktop/Golden Eye/Pics_GUI/Main/t_btn1.png")
