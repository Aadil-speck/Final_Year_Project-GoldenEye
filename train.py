...
class Train:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"/home/pi/Desktop/Golden Eye/Pics_GUI/Main/bg1.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Golden Eye Trainer",font=("verdana",30,"bold"),bg="white",fg="navyblue")
